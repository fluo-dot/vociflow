...
import { ArrowLeft, CheckCircle2, XCircle, RefreshCw, Award, ArrowLeftRight, Loader2 } from "lucide-react";
...
function StudyModeContent() {
  ...
  if (!deck || deck.cards.length === 0) return <div className="p-20 text-center text-destructive font-bold">Keine Karten vorhanden.</div>;
